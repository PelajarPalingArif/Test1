...
class PhoneNumbersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone_number" do
    assert_difference("PhoneNumber.count") do
      post phone_numbers_url, params: { phone_number: { user_id: @phone_number.user_id, value: @phone_number.value } }
    end
  ...
  test "should update phone_number" do
    patch phone_number_url(@phone_number), params: { phone_number: { user_id: @phone_number.user_id, value: @phone_number.value } }
